...
FROM b3gqy_user_profiles up1
	LEFT JOIN b3gqy_user_profiles up2
		ON up2.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up3
		ON up3.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up4
		ON up4.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up5
		ON up5.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up6
		ON up6.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up7
		ON up7.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up8
		ON up8.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up9
		ON up9.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up10
		ON up10.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up11
		ON up11.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up12
		ON up12.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up13
		ON up13.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up14
		ON up14.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up15
		ON up15.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up16
		ON up16.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up17
		ON up17.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up18
		ON up18.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up19
		ON up19.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up20
		ON up20.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up21
		ON up21.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up22
		ON up22.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up23
		ON up23.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up24
		ON up24.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up25
		ON up25.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up26
		ON up26.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up27
		ON up27.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up28
		ON up28.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up29
		ON up29.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up30
		ON up30.user_id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up31
		ON up31.user_id = up1.user_id
	LEFT JOIN b3gqy_users up32
		ON up32.id = up1.user_id
	LEFT JOIN b3gqy_user_profiles up33
