...
switch ($item->browserNav) {
	default:
	case 0: ?>
		<a <?php echo $class; ?>href="<?php echo $item->flink; ?>" <?php echo $title; ?>><?php echo $icon . ' ' . $linktype; ?></a><span class="nav_more"><span><i class="fa fa-caret-right"></i></span></span>
		<?php break;

	case 1: ?>
		<a <?php echo $class; ?>href="<?php echo $item->flink; ?>" target="_blank" <?php echo $title; ?>><?php echo $icon . ' ' .$linktype; ?></a>
		<?php break;
