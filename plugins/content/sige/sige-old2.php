...
class PlgContentSige extends JPlugin
{
	...
	private function getHeadData($sigeCss)
	{
		...
		if ($this->sigCountArticles == 0) {
			$head = array();
//			$head[] = '<link rel="stylesheet" href="' . $this->liveSite . '/plugins/content/sige/plugin_sige/sige.css" media="screen" />';

			if ($this->pluginParameters['js'] == 1) {
				JHtml::_('behavior.framework');

				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/slimbox.js"></script>';
				$head[] = '<script>
				...
				if ($this->pluginParameters['lang'] == 'de-DE') {
					$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/lytebox.js"></script>';
				} else {
					$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/lytebox_en.js"></script>';
				}
				...
				if ($this->pluginParameters['lang'] == 'de-DE') {
					$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/shadowbox.js"></script>';
				} else {
					$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/shadowbox_en.js"></script>';
				}

				$head[] = '<link rel="stylesheet" href="' . $this->liveSite . '/plugins/content/sige/plugin_sige/shadowbox.css" type="text/css" media="screen" />';
				$head[] = '<script>Shadowbox.init();</script>';
			} elseif ($this->pluginParameters['js'] == 4) {
				JHtml::_('behavior.framework');

				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/milkbox.js"></script>';
				...
				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/slimbox2.js"></script>';
				$head[] = '<script>
                                if (!/android|iphone|ipod|series60|symbian|windows ce|blackberry/i.test(navigator.userAgent)) {
                                    jQuery(function($) {
                                        $("a[rel^=\'lightbox\']").slimbox({counterText: "' . JText::_('PLG_SIGE_SLIMBOX_IMAGES') . '"}, null, function(el) {
				...
				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/venobox/venobox.js"></script>';

				$venoboxIni = '<script>jQuery(document).ready(function(){jQuery(\'.venobox\').venobox(';
				...
				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/photoswipe/photoswipe.min.js"></script>';
				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/photoswipe/photoswipe-ui-default.min.js"></script>';
				$head[] = '<script src="' . $this->liveSite . '/plugins/content/sige/plugin_sige/photoswipe/photoswipe.sige.min.js"></script>';
