...
/*
	В целях безопасности мы рекомендуем переименовать файл "zeos_antivirus.php" на любое другое название с расширением PHP.
	Переименованный файл закачать куда-то очень далеко и поглубже от корня сайта.
*/
...
// Путь к корню сайта.
$docroot = "/home/u410502/p3week.ru/www/";

// Путь к файлу антивируса от корня сайта.
$script_filename = "/administrator/includes/pages.php";
